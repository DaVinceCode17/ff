...
public class OrderDAO {
    ...
    public List<Order> getOrdersByCustomer(int customerId) throws SQLException {
        List<Order> list = new ArrayList<>();
        String sql = "SELECT 'pending' as status, o.id, o.customer_id, o.services, o.service_type, o.queue_number, o.weight, o.price, o.created_at, o.updated_at, c.first_name, c.last_name FROM pending_orders o LEFT JOIN customers c ON o.customer_id = c.id WHERE o.customer_id = ? " +
                     "UNION ALL " +
                     "SELECT 'ongoing' as status, o.id, o.customer_id, o.services, o.service_type, o.queue_number, o.weight, o.price, o.created_at, o.updated_at, c.first_name, c.last_name FROM ongoing_orders o LEFT JOIN customers c ON o.customer_id = c.id WHERE o.customer_id = ? " +
                     "UNION ALL " +
                     "SELECT 'pickup' as status, o.id, o.customer_id, o.services, o.service_type, o.queue_number, o.weight, o.price, o.created_at, o.updated_at, c.first_name, c.last_name FROM pickup_orders o LEFT JOIN customers c ON o.customer_id = c.id WHERE o.customer_id = ? " +
                     "UNION ALL " +
                     "SELECT 'delivered' as status, o.id, o.customer_id, o.services, o.service_type, o.queue_number, o.weight, o.price, o.created_at, o.created_at as updated_at, c.first_name, c.last_name FROM delivered_orders o LEFT JOIN customers c ON o.customer_id = c.id WHERE o.customer_id = ? " +
    ...
    private Order mapDelivered(ResultSet rs) throws SQLException {
        ...
        o.setPrice(rs.getDouble("price"));
        o.setCreatedAt(rs.getString("created_at"));
        o.setUpdatedAt(rs.getString("created_at"));
    ...
    private Order mapAllWithStatus(ResultSet rs) throws SQLException {
        ...
        // ✅ I-CHECK KUNG MAY COLUMN 'updated_at'
        try {
            o.setUpdatedAt(rs.getString("updated_at"));
